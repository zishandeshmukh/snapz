...
CREATE TABLE public.content_documents (
    ...
    --
    -- === THIS IS THE CORRECTED FTS COLUMN ===
    --
    fts TSVECTOR GENERATED ALWAYS AS (
        ...
        to_tsvector('simple',
            CASE
                ...
                -- If yes, convert jsonb array -> text array -> single text string
                THEN array_to_string(jsonb_array_to_text_array(metadata -> 'keywords'), ' ')
