...
// In the fakeMemories array, add raw_text to each entry:
const fakeMemories = [
  {
    metadata: {
      title: 'Welcome to SnapMind! 🎉',
    ...
    source: 'M',
    raw_text: 'Welcome to SnapMind! This is your first memory. Tap the heart icon to favorite it or click the + button to add more!', // ✅ ADD THIS
  },
  // ... repeat for all other fake memories
];
