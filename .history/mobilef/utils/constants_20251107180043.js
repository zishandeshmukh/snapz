...
// // // This URL points to the backend server you are running on your computer
// // export const BACKEND_API_URL = `http://${YOUR_COMPUTER_IP}:3001`;
// // This MUST be your computer's IP
// --- IMPORTANT ---
// 1. Find your computer's IP (e.g., '192.168.1.10')
// 2. Your phone MUST be on the same WiFi as your computer.
// 3. Replace 'YOUR_COMPUTER_IP_HERE' with that IP.
const YOUR_COMPUTER_IP = 'YOUR_COMPUTER_IP_HERE'; // e.g., '192.168.1.10'
...
// This URL points to the backend server you are running on your computer
export const BACKEND_API_URL = `http://${10.30.206.76}:3001`;

// const YOUR_COMPUTER_IP = '10.30.206.76'; // <-- REPLACE THIS