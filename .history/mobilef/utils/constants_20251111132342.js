...
export const YOUR_COMPUTER_IP = '10.30.206.76';   // change once you deploy
...
export const BACKEND_API_URL   = `http://${YOUR_COMPUTER_IP}:10000`;
export const REDIRECT_URL      = `exp://${YOUR_COMPUTER_IP}:8081`;